...
class Settings(BaseSettings):
    ...
    tier_alert_email_schedule_cron: str = "15 4 * * *"   # 10:00 AM NPT (UTC+5:45)
    # Once-daily afternoon check — 3:00 PM NPT (9:15 UTC). Dedup ensures no re-spam.
    tier_breach_immediate_check_cron: str = "15 9 * * *"  # 3:00 PM NPT
