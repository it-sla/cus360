# Graph Report - customer360  (2026-09-11)

## Corpus Check
- 1364 files · ~630,393 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7455 nodes · 10354 edges · 1370 communities (1269 shown, 101 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 375 edges (avg confidence: 0.51)
...
- .opencode/skills/design-system/scripts/slide_search_core.py
- devDependencies
- react
- spacing
- TestTailwindConfigGenerator
- .agents/skills/design-system/scripts/html-token-validator.py
- .opencode/skills/design-system/scripts/html-token-validator.py
- TestTailwindConfigGenerator
- api
- crm_worker.py
- compilerOptions
...
- .opencode/skills/design-system/scripts/fetch-background.py
- TailwindConfigGenerator
- BM25
...
- .opencode/skills/design-system/scripts/validate-tokens.cjs
- card
- .generate_config_string
...
- .opencode/skills/design-system/scripts/generate-tokens.cjs
- button
- ._base_config
...
- Token Architecture
- .opencode/skills/brand/references/update.md
- Logo Design Reference
- Token Architecture
- Primitive Tokens
- Primitive Tokens
...
8. `Shipment` - 54 edges
9. `now()` - 52 edges
10. `serialize()` - 48 edges

## Surprising Connections (you probably didn't know these)
- `TestDomainDetection` --uses--> `BM25`  [INFERRED]
  .opencode/skills/ui-ux-pro-max/scripts/tests/test_core.py → .agents/skills/design/scripts/cip/core.py
...
## Communities (1370 total, 101 thin omitted)

### Community 0 - "Session"
Cohesion: 0.10
Nodes (48): admin_audit_logs(), ae_import_batch(), ae_import_batches(), ae_import_rows(), aliases(), backfills(), companies(), company() (+40 more)

### Community 1 - "time-series-chart-shell.tsx"
Cohesion: 0.07
Nodes (39): AreaChart(), AreaChartProps, ChartInner(), ChartInnerProps, DEFAULT_MARGIN, extractAreaConfigs(), AreaChartLoading(), AreaChartLoadingProps (+31 more)

### Community 2 - "CrmSessionManager"
Cohesion: 0.05
Nodes (118): AeWorkbookError, ValueError, AeTargetWorkbookError, ValueError, LoginRequest, BaseModel, CompanyWorkbookError, ValueError (+110 more)
...
### Community 7 - ".agents/skills/design-system/scripts/slide_search_core.py"
Cohesion: 0.09
Nodes (36): format_context(), format_result(), main(), Format a single search result for display, Format contextual recommendations for display., BM25, calculate_pattern_break(), detect_domain() (+28 more)

### Community 8 - "test_crm_reliability.py"
Cohesion: 0.08
Nodes (54): RetryableConnectorError, DuplicateTrackingConflict, EmptyManifestError, ManifestDetail, parse_manifest_detail(), upsert_detail(), retry_delay(), FastCrmSession (+46 more)
...
Cohesion: 0.09
Nodes (23): autoprefixer, devDependencies, autoprefixer, oxlint, postcss, tailwindcss, @tailwindcss/postcss, @types/node (+15 more)

### Community 11 - "react"
Cohesion: 0.03
Nodes (33): HighlightSegment(), HighlightSegmentProps, SeriesHighlightLayerProps, ExecutiveLayoutProps, KpiCardProps, LucideIcon, Avatar, AvatarFallback (+25 more)
...
### Community 14 - ".agents/skills/design-system/scripts/html-token-validator.py"
Cohesion: 0.14
Nodes (24): get_context(), is_allowed_exception(), is_allowed_rgba(), is_inside_block(), load_css_variables(), main(), print_result(), print_summary() (+16 more)

### Community 15 - ".opencode/skills/design-system/scripts/html-token-validator.py"
Cohesion: 0.14
Nodes (24): get_context(), is_allowed_exception(), is_allowed_rgba(), is_inside_block(), load_css_variables(), main(), print_result(), print_summary() (+16 more)
...
### Community 17 - "api"
Cohesion: 0.15
Nodes (10): api, LeaderboardEntry, Shipment, CrmSync(), fmtDate(), bylineFor(), Leaderboard(), Metric (+2 more)

### Community 18 - "crm_worker.py"
Cohesion: 0.12
Nodes (54): activate_next_chunk(), cancel_backfill(), chunk_ranges(), create_backfill(), create_incremental(), earliest_state(), incremental_range(), pause_backfill() (+46 more)
...
### Community 21 - "normalize_icris"
Cohesion: 0.22
Nodes (22): analyze(), cell_text(), clean_header(), clean_text(), import_companies(), parse_workbook(), Session, Transactional, grouped import for the authoritative ICRIS company master. (+14 more)
...
Cohesion: 0.08
Nodes (31): _prune_notification_state(), Drops seen/snoozed entries for ids no longer live, so a resolved-then-recurring…, ActivityLog, AeImportBatch, AeImportRow, AeReassignmentLog, AeTarget, Base (+23 more)
...
### Community 31 - "api.ts"
Cohesion: 0.04
Nodes (49): AccountExecutive, adminApi, AdminUser, AdminUserPatch, AeImportBatch, AeImportRow, AEPerformanceResponse, AeReassignmentLogEntry (+41 more)

### Community 32 - "compilerOptions"
Cohesion: 0.10
Nodes (19): compilerOptions, allowImportingTsExtensions, erasableSyntaxOnly, lib, module, moduleDetection, noEmit, noFallthroughCasesInSwitch (+11 more)

### Community 33 - ".opencode/skills/design-system/scripts/generate-slide.py"
Cohesion: 0.15
Nodes (19): _e(), generate_chart_slide(), generate_cta_slide(), generate_deck(), generate_metrics_slide(), generate_problem_slide(), generate_solution_slide(), generate_testimonial_slide() (+11 more)
...
### Community 39 - ".opencode/skills/design-system/scripts/fetch-background.py"
Cohesion: 0.17
Nodes (17): generate_css_for_background(), get_background_image(), get_curated_images(), get_overlay_css(), get_pexels_search_url(), load_backgrounds_config(), load_brand_colors(), main() (+9 more)
...
### Community 49 - "imports.py"
Cohesion: 0.34
Nodes (10): import_manifest(), match_company(), preview_manifest(), Session, read_file(), clean(), decimal(), integer() (+2 more)

### Community 50 - ".opencode/skills/design/scripts/icon/generate.py"
Cohesion: 0.20
Nodes (15): apply_color(), apply_viewbox_size(), extract_svgs(), generate_batch(), generate_icon(), generate_sizes(), load_env(), main() (+7 more)
...
### Community 54 - "TestShadcnInstaller"
Cohesion: 0.12
...
### Community 59 - ".agents/skills/brand/scripts/validate-asset.cjs"
Cohesion: 0.25
Nodes (13): checkManifest(), formatBytes(), formatOutput(), fs, main(), parseFilename(), path, RULES (+5 more)

### Community 60 - "pie-context.tsx"
Cohesion: 0.07
...
### Community 63 - ".opencode/skills/brand/scripts/validate-asset.cjs"
Cohesion: 0.25
Nodes (13): checkManifest(), formatBytes(), formatOutput(), fs, main(), parseFilename(), path, RULES (+5 more)

### Community 64 - ".opencode/skills/ui-ux-pro-max/scripts/core.py"
Cohesion: 0.21
...
### Community 65 - ".opencode/skills/ui-ux-pro-max/scripts/tests/test_core.py"
Cohesion: 0.18
...
### Community 70 - ".generate_config_string"
Cohesion: 0.20
Nodes (6): Generate configuration file content. Returns: Configuration file as string, Generate TypeScript configuration., Generate JavaScript configuration., Format plugins array for config. Validates each plugin name against a strict…, Add indentation to JSON string., Write configuration to file. Returns: Tuple of (success, message)

### Community 71 - ".opencode/skills/design-system/scripts/validate-tokens.cjs"
Cohesion: 0.24
Nodes (11): extensions, formatReport(), fs, getFiles(), main(), parseArgs(), path, patterns (+3 more)
...
### Community 74 - ".agents/skills/brand/scripts/inject-brand-context.cjs"
Cohesion: 0.31
Nodes (10): extractColorsFromTable(), extractCoreAttributes(), extractHexColors(), extractImageStyle(), extractTypography(), extractVoice(), fs, generatePromptAddition() (+2 more)

### Community 75 - ".agents/skills/design-system/scripts/embed-tokens.cjs"
Cohesion: 0.18
...
### Community 77 - ".agents/skills/ui-styling/scripts/tests/test_tailwind_config_gen.py"
Cohesion: 0.22
...
### Community 80 - ".opencode/skills/design-system/scripts/embed-tokens.cjs"
Cohesion: 0.18
Nodes (8): args, fs, minimal, MINIMAL_TOKENS, path, projectRoot, tokensPath, wrapStyle
...
### Community 83 - ".opencode/skills/ui-styling/scripts/tests/test_tailwind_config_gen.py"
Cohesion: 0.22
Nodes (8): parametrize, Tests for tailwind_config_gen.py, Reduce a generated TS/JS config to a bare assignable object so it can be handed…, Regression guard for the missing-comma bug between the ``theme`` block and…, The property preceding ``plugins`` must end with a comma (pure-Python check, so…, The emitted config parses as valid JS via ``node --check``., _strip_to_object(), TestGeneratedConfigIsValidJs
...
### Community 86 - ".agents/skills/design-system/scripts/generate-tokens.cjs"
Cohesion: 0.36
Nodes (9): flattenTokens(), fs, generateCSS(), generateTailwind(), main(), parseArgs(), path, resolveReference() (+1 more)

### Community 87 - "chart-context.tsx"
Cohesion: 0.08
Nodes (36): ChartHoverContext, ChartHoverContextValue, ChartProvider(), ChartStableContext, ChartStableContextValue, ScaleBand, ScaleLinear, ScaleTime (+28 more)

### Community 88 - "duration"
Cohesion: 0.20
Nodes (10): fast, normal, slow, $type, $value, $type, $value, duration (+2 more)

### Community 89 - "._base_config"
Cohesion: 0.22
...
Cohesion: 0.31
Nodes (7): Settings, configured(), test_allowed_hosts_are_trimmed_and_casefolded(), test_disabled_state(), test_enabled_settings_types_and_blank_import_detail(), test_secret_fields_are_hidden_from_repr(), BaseSettings
...
### Community 93 - ".opencode/skills/design/scripts/logo/generate.py"
Cohesion: 0.29
Nodes (9): enhance_prompt(), generate_batch(), generate_logo(), load_env(), main(), Enhance the logo prompt with style and industry modifiers, Generate a logo using Gemini models with image generation Args: aspect_ratio:…, Generate multiple logo variants with different styles (+1 more)

### Community 94 - ".opencode/skills/design-system/scripts/generate-tokens.cjs"
Cohesion: 0.36
Nodes (9): flattenTokens(), fs, generateCSS(), generateTailwind(), main(), parseArgs(), path, resolveReference() (+1 more)
...
### Community 97 - ".agents/skills/brand/scripts/sync-brand-to-tokens.cjs"
Cohesion: 0.33
...
### Community 106 - "remote-compose.sh"
Cohesion: 0.50
Nodes (8): compose(), die(), ensure_remote_dir(), init_remote(), remote(), remote-compose.sh script, sync_project(), usage()

### Community 107 - "button"
Cohesion: 0.09
Nodes (28): fg, font-size, hover-bg, padding-x, padding-y, radius, radius, component (+20 more)

### Community 108 - "navigation-menu.tsx"
Cohesion: 0.25
...
### Community 114 - "card.tsx"
Cohesion: 0.29
Nodes (6): Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle

### Community 115 - "main.py"
Cohesion: 0.10
Nodes (40): ae_performance(), calc_pop(), call_log_payload(), company_analytics(), company_call_logs(), compute_alerts(), customer_profitability(), _doc_type_bucket() (+32 more)
...
### Community 121 - "series-markers.tsx"
Cohesion: 0.08
...
### Community 122 - "test_tier_alerts_email.py"
Cohesion: 0.10
Nodes (29): _ae_codes_with_email(), _format_admin_summary(), _format_ae_digest(), _html_wrap(), Session, Gmail SMTP (app password) email digests for Tier Shipping Gap alerts. Full…, Aggregate-only report for admins: totals, per-AE, per-tier, and a handful of…, Returns a summary dict of what was (or would have been) sent, for the admin… (+21 more)

### Community 123 - "Brand Guidelines v1.0"
Cohesion: 0.05
Nodes (37): 1. Color Palette, 2. Typography, 3. Logo Usage, 4. Voice & Tone, 5. Imagery Guidelines, 6. Design Components, Accessibility, AI Image Generation (+29 more)

### Community 124 - "Design"
Cohesion: 0.06
...
Cohesion: 0.09
Nodes (25): customer_master_ready(), crm_item_payload(), crm_progress(), crm_run(), crm_run_payload(), crm_status(), describe_crm_schedule(), diagnose_crm_list() (+17 more)

### Community 130 - "area.tsx"
Cohesion: 0.12
...
### Community 132 - "User"
Cohesion: 0.10
Nodes (32): analytics_customers(), analytics_dashboard(), bill_types(), company_conflicts(), completeness(), data_quality(), destinations(), download_admin_backup() (+24 more)

### Community 133 - "ae_imports.py"
Cohesion: 0.11
Nodes (28): AeImportBatch, analyze(), cell_text(), clean_header(), clean_text(), import_ae_assignments(), normalize_ae_value(), parse_workbook() (+20 more)

### Community 134 - "y-domain-utils.ts"
Cohesion: 0.13
...
### Community 141 - "UUID"
Cohesion: 0.13
Nodes (48): add_alias(), admin_issue_setup_link(), admin_update_user(), archive_document(), assign_ae(), backfill_cancel(), backfill_detail(), backfill_pause() (+40 more)

### Community 142 - "Design"
Cohesion: 0.06
Nodes (35): Banner Design (Built-in), Banner: Design Rules, Banner: Quick Size Reference, Banner: Top Art Styles, Banner: Workflow, CIP Design (Built-in), CIP: Generate Brief, CIP: Generate Mockups (+27 more)

### Community 143 - "Canvas Design System"
Cohesion: 0.06
Nodes (35): 1. Visual Communication First, 2. Minimal Text Integration, 3. Expert Craftsmanship, 4. Systematic Patterns, Analog Meditation, Approach, Canvas Boundaries, Canvas Design System (+27 more)

### Community 144 - "auth.py"
Cohesion: 0.12
Nodes (25): AuthUserOut, create_session_token(), find_user_by_setup_token(), generate_setup_token(), get_ae_scope(), get_current_user(), _hash_token(), datetime (+17 more)
...
### Community 146 - "Prerequisites"
Cohesion: 0.06
Nodes (33): Accessibility, Available Domains, Available Stacks, Common Rules for Professional UI, Common Sticking Points, Example Workflow, How to Use This Skill, Icons & Visual Elements (+25 more)

### Community 147 - "Form & Input Components"
Cohesion: 0.06
Nodes (32): Accordion, Alert, Alert Dialog, Avatar, Badge, Button, Card, Checkbox (+24 more)

### Community 148 - "Tailwind CSS Responsive Design"
Cohesion: 0.06
Nodes (32): 1. Mobile-First Design, 2. Consistent Breakpoint Usage, 3. Test at Breakpoint Boundaries, 4. Use Container for Content Width, 5. Progressive Enhancement, 6. Avoid Too Many Breakpoints, Best Practices, Breakpoint System (+24 more)

### Community 149 - "x-axis.tsx"
Cohesion: 0.12
Nodes (21): hmsTimeFmt, shortDateFmt, weekdayDateFmt, allIndexLayouts(), AxisTick, binomial(), buildDataAlignedTicks(), composePositiveSum() (+13 more)
...
Cohesion: 0.05
Nodes (73): _add_alias(), _call_log_hash(), _counter(), exact_company(), invalid_icris_reason(), issue(), link_icris(), normalized_tracking() (+65 more)

### Community 158 - "DataQualityIssue"
Cohesion: 0.16
Nodes (23): _detect_pushed_followups(), Flags deals that were overdue and unresolved in the previous snapshot but…, Replace the pipeline_items table with the current CRM Active Pipeline snapshot.…, sync_active_pipeline(), DataQualityIssue, The 30-day buffer must cover crm_invalid_icris too, not just crm_blank_icris —…, crm_icris_not_in_master is a different situation entirely (waiting on a…, _seed_icris_issue() (+15 more)
...
### Community 168 - "Component Specifications"
Cohesion: 0.07
Nodes (28): Alert, Anatomy, Anatomy, Anatomy, Anatomy, Anatomy, Badge, Button (+20 more)

### Community 169 - "shadcn/ui Accessibility Patterns"
Cohesion: 0.07
...
### Community 174 - "Logo Usage Rules"
Cohesion: 0.07
Nodes (28): Absolute Don'ts, Approved Backgrounds, Before Using Logo, Clear Space, Co-branding, Color Rules, Color Usage, Color Variants (+20 more)
...
### Community 184 - "Asset Approval Checklist"
Cohesion: 0.08
Nodes (25): Accessibility, Archival, Asset Approval Checklist, Automation Support, Color Compliance, Common Issues & Fixes, Content Accessibility, Content Quality (+17 more)

### Community 185 - "Logo AI Prompt Engineering"
Cohesion: 0.08
Nodes (25): Common Pitfalls, Core Prompt Structure, Detailed Brief, Eco/Sustainable, Effective Keywords by Style, Fashion Brand, Healthcare, Industry-Specific Prompts (+17 more)

### Community 186 - "Color Palette Management"
Cohesion: 0.08
...
### Community 191 - "CIP Deliverable Guide"
Cohesion: 0.08
...
Cohesion: 0.10
Nodes (9): DocumentTypeAnalytics(), fmt$(), fmtNum(), ExecutiveOverview(), fmt$(), fmtNum(), GeographyAnalytics(), LandingPage() (+1 more)
...
### Community 204 - "Color Palette Management"
Cohesion: 0.08
Nodes (24): Accessibility Requirements, Brand Compliance Validation, Checking Contrast, Color Documentation Format, Color Extraction, Color Palette Examples, Color Palette Management, Color System Structure (+16 more)
...
### Community 208 - "projection-config.ts"
Cohesion: 0.13
...
### Community 247 - "States and Variants"
Cohesion: 0.08
Nodes (24): Accessibility, Accessibility Requirements, ARIA States, Color Contrast, Color Variants, Disabled States, Error Messages, Error States (+16 more)

### Community 248 - "UI Styling Skill"
Cohesion: 0.08
Nodes (24): Accessibility Patterns, Alternative: Tailwind-Only Setup, Best Practices, Common Patterns, Component Layer: shadcn/ui, Component Library Guide, Component + Styling Setup, Core Stack (+16 more)
...
### Community 250 - "Workflow"
Cohesion: 0.08
Nodes (23): Art Direction Styles (Reuse from Banner), Color & Contrast, Design Best Practices, HTML Design Rules, HTML Template Structure, Option A: Chrome Headless CLI (Recommended — zero dependencies), Option B: chrome-devtools skill, Option C: Playwright script (+15 more)

### Community 251 - "Design System"
Cohesion: 0.09
...
### Community 252 - "Tailwind CSS Customization"
Cohesion: 0.09
Nodes (22): @apply Directive, Best Practices, Color Customization, Complete Tailwind Config, Configuration Examples, Content Configuration, Custom Color Palette, Custom Font Sizes (+14 more)

### Community 253 - "Design System"
Cohesion: 0.09
Nodes (22): Best Practices, Chart.js Integration, Command, Component Spec Pattern, Contextual Decision Flow, Decision System CSVs, Design System, Integration (+14 more)

### Community 254 - "Tailwind CSS Customization"
Cohesion: 0.09
Nodes (22): @apply Directive, Best Practices, Color Customization, Complete Tailwind Config, Configuration Examples, Content Configuration, Custom Color Palette, Custom Font Sizes (+14 more)

### Community 255 - "Routing by Task Type"
Cohesion: 0.10
...
### Community 256 - "shadcn/ui Theming & Customization"
Cohesion: 0.10
...
### Community 257 - "Routing by Task Type"
Cohesion: 0.10
Nodes (19): Banner Design Tasks, Brand Identity Tasks, Component Creation, Corporate Identity Program Tasks, Design Routing Guide, Design System Migration, Icon Design Tasks, Implementation Tasks (+11 more)

### Community 258 - "shadcn/ui Theming & Customization"
Cohesion: 0.10
Nodes (19): Base Color Presets, Best Practices, Color Customization, Color Format, Component Customization, CSS Variable System, Customize Styles, Customize Variants (+11 more)

### Community 259 - "Asset Organization Guide"
Cohesion: 0.11
...
### Community 260 - "Primary Color Meanings"
Cohesion: 0.11
...
### Community 261 - "Core Logo Types"
Cohesion: 0.11
Nodes (18): 1. Wordmark (Logotype), 2. Lettermark (Monogram), 3. Pictorial Mark (Brand Mark), 4. Abstract Mark, 5. Mascot, 6. Emblem, 7. Combination Mark, Aesthetic Styles (+10 more)

### Community 262 - "Customer 360 - AI Architecture & Domain Context"
Cohesion: 0.11
Nodes (18): 1. Executive Summary & Purpose, 2. Technology Stack & Infrastructure, 3. Data Models & Database Schema, 4. Non-Negotiable Domain Rules & Business Invariants, 5. Ingestion, Matching & Synchronization Pipelines, 6.1 Design Principles (Enterprise UI), 6.2 Application Routing & Views, 6. Frontend UI Architecture (+10 more)

### Community 263 - "Asset Organization Guide"
Cohesion: 0.11
Nodes (18): Asset Entry (manifest.json), Asset Organization Guide, By Campaign, By Status, By Type, Cleanup Workflow, Components, Directory Structure (+10 more)

### Community 264 - "Primary Color Meanings"
Cohesion: 0.11
Nodes (18): Accessibility Considerations, Analogous, Black, Blue, Color Combinations by Industry, Color Harmony Types, Complementary, Green (+10 more)

### Community 265 - "Core Logo Types"
Cohesion: 0.11
Nodes (18): 1. Wordmark (Logotype), 2. Lettermark (Monogram), 3. Pictorial Mark (Brand Mark), 4. Abstract Mark, 5. Mascot, 6. Emblem, 7. Combination Mark, Aesthetic Styles (+10 more)

### Community 266 - "Brand Consistency Checklist"
Cohesion: 0.11
Nodes (17): Audit Frequency, Brand Consistency Checklist, Channel Audit, Collateral, Colors, Common Issues, Email, Imagery (+9 more)

### Community 267 - "CIP Mockup Prompt Engineering"
Cohesion: 0.11
...
### Community 269 - "Brand Consistency Checklist"
Cohesion: 0.11
Nodes (17): Audit Frequency, Brand Consistency Checklist, Channel Audit, Collateral, Colors, Common Issues, Email, Imagery (+9 more)

### Community 270 - "CIP Mockup Prompt Engineering"
Cohesion: 0.11
Nodes (17): Apparel (Polo/T-Shirt), Base Prompt Structure, Business Card, CIP Mockup Prompt Engineering, Context Modifiers, Corporate Minimal, Deliverable-Specific Modifiers, Letterhead (+9 more)

### Community 271 - "Color Semantics"
Cohesion: 0.11
Nodes (17): Accent, Applying Semantic Tokens, Background & Foreground, Border & Ring, Color Semantics, Dark Mode Overrides, Destructive, Interactive States (+9 more)

### Community 272 - "Design System Master File"
Cohesion: 0.11
...
### Community 273 - "Design System Master File"
Cohesion: 0.12
...
### Community 274 - "Design Principles"
Cohesion: 0.12
...
### Community 275 - "Design Principles"
Cohesion: 0.12
Nodes (15): 22 Art Direction Styles, Banner Sizes & Art Direction Styles Reference, Complete Banner Sizes, CTA Rules, Design Principles, Pinterest Research Queries, Print, Print Specs (+7 more)

### Community 276 - "Design Principles"
Cohesion: 0.12
Nodes (15): 22 Art Direction Styles, Banner Sizes & Art Direction Styles Reference, Complete Banner Sizes, CTA Rules, Design Principles, Pinterest Research Queries, Print, Print Specs (+7 more)

### Community 277 - "Design Principles"
Cohesion: 0.12
Nodes (15): 22 Art Direction Styles, Banner Sizes & Art Direction Styles Reference, Complete Banner Sizes, CTA Rules, Design Principles, Pinterest Research Queries, Print, Print Specs (+7 more)

### Community 278 - "CIP Design Reference"
Cohesion: 0.13
...
### Community 279 - "Icon Design Reference"
Cohesion: 0.13
...
### Community 280 - "Copywriting Formulas"
Cohesion: 0.13
Nodes (14): AIDA (Attention-Interest-Desire-Action), Before-After-Bridge, Contrast Patterns, Copywriting Formulas, Core Formulas, Cost of Inaction, FAB (Features-Advantages-Benefits), Formula-to-Slide Mapping (+6 more)

### Community 281 - "Copywriting Formulas"
Cohesion: 0.13
Nodes (14): AIDA (Attention-Interest-Desire-Action), Before-After-Bridge, Contrast Patterns, Copywriting Formulas, Core Formulas, Cost of Inaction, FAB (Features-Advantages-Benefits), Formula-to-Slide Mapping (+6 more)

### Community 282 - "CIP Design Reference"
Cohesion: 0.13
Nodes (14): CIP Brief (Start Here), CIP Design Reference, Commands, Deliverable Categories, Design Styles, Detailed References, Generate Mockups, HTML Presentation Features (+6 more)

### Community 283 - "Icon Design Reference"
Cohesion: 0.13
Nodes (14): Available Styles, CLI Options, Commands, Generate Batch Variations, Generate Multiple Sizes, Generate Single Icon, Icon Categories, Icon Design Reference (+6 more)

### Community 284 - "Copywriting Formulas"
Cohesion: 0.13
Nodes (14): AIDA (Attention-Interest-Desire-Action), Before-After-Bridge, Contrast Patterns, Copywriting Formulas, Core Formulas, Cost of Inaction, FAB (Features-Advantages-Benefits), Formula-to-Slide Mapping (+6 more)
...
### Community 287 - "Copywriting Formulas"
Cohesion: 0.13
Nodes (14): AIDA (Attention-Interest-Desire-Action), Before-After-Bridge, Contrast Patterns, Copywriting Formulas, Core Formulas, Cost of Inaction, FAB (Features-Advantages-Benefits), Formula-to-Slide Mapping (+6 more)

### Community 288 - "Banner Design - Multi-Format Creative Banner System"
Cohesion: 0.14
...
### Community 289 - "Messaging Framework"
Cohesion: 0.14
...
### Community 290 - "Brand Voice Framework"
Cohesion: 0.14
...
### Community 291 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 292 - "Tailwind Integration"
Cohesion: 0.14
...
### Community 293 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 294 - "Banner Design - Multi-Format Creative Banner System"
Cohesion: 0.14
Nodes (13): Art Direction Styles (Top 10), Banner Design - Multi-Format Creative Banner System, Banner Size Quick Reference, Design Rules, Prerequisites, Security, Step 1: Gather Requirements (AskUserQuestion), Step 2: Research & Art Direction (+5 more)

### Community 295 - "Messaging Framework"
Cohesion: 0.14
Nodes (13): Core Statements, Elevator Pitches, Framework Structure, Message Architecture, Message by Audience, Message Testing, Messaging Framework, Mission Statement (+5 more)

### Community 296 - "Brand Voice Framework"
Cohesion: 0.14
Nodes (13): Brand Voice Framework, Character Spectrum, Emotion Spectrum, Language Spectrum, Step 1: Define Personality Traits, Step 2: Create Voice Chart, Step 3: Context Adaptation, Tone Spectrum (+5 more)

### Community 297 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 298 - "Tailwind Integration"
Cohesion: 0.14
Nodes (13): Animation Tokens, Base Layer, Button Example, Component Classes, CSS Variables Setup, Dark Mode Toggle, HSL Format Benefits, shadcn/ui Alignment (+5 more)

### Community 299 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 300 - ".agents/skills/brand/references/update.md"
Cohesion: 0.15
...
### Community 301 - "Logo Design Reference"
Cohesion: 0.15
...
### Community 302 - "Token Architecture"
Cohesion: 0.15
...
### Community 303 - ".opencode/skills/brand/references/update.md"
Cohesion: 0.15
Nodes (12): Color Presets, Examples, Files Modified, Important, Overview, Skills Used, Step 1: Gather Brand Input, Step 2: Update Brand Guidelines (+4 more)

### Community 304 - "Logo Design Reference"
Cohesion: 0.15
Nodes (12): Available Styles, Color Psychology, Commands, Design Brief (Start Here), Detailed References, Generate Logo, Industry Defaults, Logo Design Reference (+4 more)

### Community 305 - "Token Architecture"
Cohesion: 0.15
Nodes (12): Categories, Dark Mode, File Organization, Layer 1: Primitive Tokens, Layer 2: Semantic Tokens, Layer 3: Component Tokens, Layer Overview, Migration from Flat Tokens (+4 more)

### Community 306 - "Primitive Tokens"
Cohesion: 0.17
...
### Community 307 - "Primitive Tokens"
Cohesion: 0.17
Nodes (11): Border Radius, Color Scales, Gray Scale, Motion / Duration, Primary Colors (Blue), Primitive Tokens, Shadows, Spacing Scale (+3 more)

### Community 308 - "4. DESIGN ENGINEERING DIRECTIVES (Bias Correction)"
Cohesion: 0.17
Nodes (12): 4.10 Quotes & Testimonials, 4.11 Page Theme Lock (Light / Dark Mode Consistency), 4.1 Typography, 4.2 Color Calibration, 4.3 Layout Diversification, 4.4 Materiality, Shadows, Cards, 4.5 Interactive UI States, 4.6 Data & Form Patterns (+4 more)

### Community 309 - "Core Visual Elements"
Cohesion: 0.18
Nodes (10): Color Palette, Colors, Core Visual Elements, Logo, Logo, Quick Checks, Typography, Typography (+2 more)

### Community 310 - "CIP Design Style Guide"
Cohesion: 0.18
Nodes (10): Bold Dynamic, CIP Design Style Guide, Classic Traditional, Color Psychology, Corporate Minimal, Fresh Modern, Luxury Premium, Modern Tech (+2 more)

### Community 311 - "Core Visual Elements"
Cohesion: 0.18
Nodes (10): Color Palette, Colors, Core Visual Elements, Logo, Logo, Quick Checks, Typography, Typography (+2 more)

### Community 312 - "CIP Design Style Guide"
Cohesion: 0.18
Nodes (10): Bold Dynamic, CIP Design Style Guide, Classic Traditional, Color Psychology, Corporate Minimal, Fresh Modern, Luxury Premium, Modern Tech (+2 more)

### Community 313 - "Customer 360"
Cohesion: 0.18
Nodes (10): Architecture, Customer 360, Data quality and backups, Documents and analytics, Import rules, Local Docker (optional), MAWB and source precedence, Read-only legacy CRM connector (+2 more)

### Community 314 - "Customer 360 domain rules"
Cohesion: 0.20
Nodes (9): Backend standalone (if DATABASE_URL points at accessible Postgres), Customer 360 domain rules, Developer commands, Key conventions, Local Docker, Remote (primary), Stack and layout, Testing (+1 more)

### Community 315 - "Brand"
Cohesion: 0.20
Nodes (9): Brand, Brand Sync Workflow, Quick Start, References, Routing, Scripts, Subcommands, Templates (+1 more)

### Community 316 - "Slide Strategies"
Cohesion: 0.20
...
### Community 317 - "Component Tokens"
Cohesion: 0.20
...
### Community 318 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)
...
### Community 322 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)

### Community 323 - "Component Tokens"
Cohesion: 0.20
Nodes (9): Alert Tokens, Badge Tokens, Button Tokens, Card Tokens, Component Tokens, Dialog/Modal Tokens, Input Tokens, Table Tokens (+1 more)

### Community 324 - "10. REFERENCE VOCABULARY (Pattern Names the Agent Should Know)"
Cohesion: 0.20
Nodes (10): 10. REFERENCE VOCABULARY (Pattern Names the Agent Should Know), Animation Library Choice, Cards & Containers, Galleries & Media, Hero Paradigms, Layout & Grids, Micro-Interactions & Effects, Navigation & Menus (+2 more)

### Community 325 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)
...
### Community 327 - "9. AI TELLS (Forbidden Patterns)"
Cohesion: 0.25
Nodes (8): 9.A Visual & CSS, 9. AI TELLS (Forbidden Patterns), 9.B Typography, 9.C Layout & Spacing, 9.D Content & Data ("Jane Doe" Effect), 9.E External Resources & Components, 9.F Production-Test Tells (banned outright), 9.G EM-DASH BAN (the single most-violated Tell)

### Community 328 - "Slides Reference"
Cohesion: 0.29
Nodes (6): Key Features, Knowledge Base, Slides Reference, Usage, When to Use, Workflow

### Community 329 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 330 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 331 - "Customer 360 Backend API Reference"
Cohesion: 0.29
Nodes (6): 1. Analytics & Executive Dashboard, 2. Companies & Customers, 3. Shipments & Packages, 4. CRM Synchronization & Data Quality, 5. File Imports & Backups, Customer 360 Backend API Reference

### Community 333 - "Open Questions"
Cohesion: 0.10
Nodes (20): Data semantics, New as of 2026-08-07, Open Questions, Operational, Product intent, Q10 — Is the stale July 28 `dist/` actually what's in front of users? *(~60%)*, Q11 — Was `AUTH_SECRET` meant to be set on the remote host? *(~55%)*, Q12 — Do you want the 117 unused-import errors fixed, or the tsconfig relaxed? (+12 more)

### Community 334 - "Slides Reference"
Cohesion: 0.29
Nodes (6): Key Features, Knowledge Base, Slides Reference, Usage, When to Use, Workflow

### Community 335 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template
...
### Community 340 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template
...
### Community 342 - "CLAUDE.md"
Cohesion: 0.10
Nodes (19): Architecture, Backend (`backend/app/`), Commands, ⚠️ Current state you must know, Data-rule probe — run before and after touching sync/import/matching, Docker services, Environment, Frontend (+11 more)

### Community 343 - "Slides"
Cohesion: 0.33
Nodes (5): References (Knowledge Base), Routing, Slides, Subcommands, When to Use

### Community 344 - "Brand Guidelines Template"
Cohesion: 0.40
Nodes (4): Brand Guidelines Template, Document Structure, Extractable Fields, Usage

### Community 345 - "Rankings.tsx"
Cohesion: 0.13
Nodes (14): xlsx, CustomerAnalytics(), fmt$(), fmtAxisDate(), fmtNum(), CustomerMetric, DEFAULT_RANK_STYLE, fmt$() (+6 more)
...
Cohesion: 0.40
Nodes (4): 🚀 2026 Enterprise Technology Stack & Architectural Standards, Customer 360 System Memory Bank & Architecture Specification, 📦 Domain Rules & Verification Order, 📊 Latest Test & Quality Metrics

### Community 348 - "Brand Guidelines Template"
Cohesion: 0.40
Nodes (4): Brand Guidelines Template, Document Structure, Extractable Fields, Usage
...
### Community 356 - "test_ae_targets.py"
Cohesion: 0.25
Nodes (16): clean_header(), extract_ae_code(), import_ae_targets(), _num(), parse_month(), parse_workbook(), Session, Import for AE monthly targets ("AE_Targets_2026.xlsx", 'All_AE_Flat' sheet):… (+8 more)

### Community 357 - "AEPerformance.tsx"
Cohesion: 0.16
...
Cohesion: 0.11
Nodes (16): 1. Local dev environment, 2. New feature: CRM Daily Call Logs, 3. UI cleanup pass (many small fixes, all verified live), 4. Data Quality: ICRIS Number Mismatch messaging, 5. Role-Based Access Control (the big one), 6. Where to pick up, Session Handover — Customer 360, 1. Roles (+8 more)

### Community 361 - "UX System Flow — Customer 360"
Cohesion: 0.12
Nodes (16): 1. Entry flow, 2. Navigation shell (present on every `/app/*` page), 3. Full route map (as built today), 4. Drill-down pattern (Customer Directory → Customer 360), 5. Command palette (Ctrl+K) behavior, 6. Consistency scorecard, 7. Docs drift (for context, not a UX finding), 8. Summary — top 5 things to fix for smoother navigation (+8 more)

### Community 362 - "Development"
Cohesion: 0.12
Nodes (16): Commands that do NOT work, Conventions when editing, Core, Coverage shape, CRM connector, Data-rule probe, Database access, Development (+8 more)

### Community 363 - "3. Feature work this session (chronological)"
Cohesion: 0.12
Nodes (15): 1. Deployment pipeline (established this session), 2. Local dev environment note, 3. Feature work this session (chronological), 4. Known issues / things to watch, 5. Where to pick up, Alerts page simplified, CRM matching investigation → "Re-check CRM" feature, Customer 360 → Shipments tab sorted by date (+7 more)

### Community 364 - "2. Findings by area"
Cohesion: 0.12
Nodes (15): 0. Environment actually used, 1. Required command results, 2. Findings by area, 3. Key data rules — verdict table, 4. Test coverage gaps, 5. What I did not test, 6. Cleanup note, A. Auth — **BROKEN (blocker)** (+7 more)

### Community 365 - "Session Handover — Customer 360"
Cohesion: 0.13
...
### Community 366 - "Core entities"
Cohesion: 0.13
Nodes (15): `ActivityLog` — `activity_logs`, `Company` — `companies`, `CompanyAlias` — `company_aliases`, `CompanyDocument` — `company_documents`, Core entities, CRM sync entities, Data Model, Data quality (+7 more)

### Community 367 - "AccountExecutive"
Cohesion: 0.15
Nodes (18): upgrade(), hash_password(), AccountExecutive, client(), fixture, Wins come from Daily Call Log stage, not pipeline_items.win_loss — that field…, An AE who closed a deal but hasn't shipped anything yet this month must still…, A role outside admin/super_admin can't use timeframe/date_from/date_to to look… (+10 more)

### Community 368 - "app-shell.tsx"
Cohesion: 0.26
...
### Community 1292 - "AnalyticsFilterBar.tsx"
Cohesion: 0.18
...
### Community 1293 - "Session Handoff Pt.2 — 2026-08-10"
Cohesion: 0.14
Nodes (13): 10. AE Assignment — new feature, built from a real spreadsheet, 1. Universal Search click-through was broken (backend + frontend), 2. Air Waybills filters — Date Range was completely dead, 3. System-wide hover-effect cleanup, 4. Business Analytics filter cleanup (Geography, Operational KPIs), 5. Customer 360 — PDF export, Analytics tab, Documents tab, 6. Customer Directory — Weight column + flexible filters, 7. Master Air Waybills — MAWB drawer was showing wrong/broken data (+5 more)

### Community 1294 - "Session Handover — Customer 360"
Cohesion: 0.14
Nodes (13): 10. Customer/Business Analytics — real "Unassigned" filter bug found and fixed, 11. Known issues spotted but NOT fixed (flagged only), 12. Where to pick up, 1. What's actually deployed vs. not, 2. Document Type (DOC) Analytics page, 3. The "transit airport vs. real destination" bug — fixed in 4 places, 4. Customer 360 — Origin filter removed, Destination filter self-emptying bug fixed, 5. Geography — "Top Countries by Revenue" chart removed (+5 more)

### Community 1295 - "Session Handover — Customer 360"
Cohesion: 0.14
Nodes (13): 10. Test suite growth this session, 11. Known issues / things to watch, 12. Where to pick up, 1. What's actually deployed vs. not, 2. Two-tier RBAC: `super_admin` vs `admin` — the big structural change, 3. Leaderboard — real Wins bug + shared DateRangeControl, 4. Small UI cleanups (each was a separate explicit request), 5. Data Quality page — redesigned, plus a real default-scope bug found (+5 more)

### Community 1296 - "1. Local Docker Workflow (Windows/Mac)"
Cohesion: 0.15
...
### Community 1299 - "admin_bulk_create_users"
Cohesion: 0.22
Nodes (11): admin_bulk_create_users(), admin_create_user(), admin_list_users(), _create_user_no_password(), issue_setup_link(), Generates a fresh one-time setup token for `user` and returns the full link an…, ae' role must point at a real, known AE code — otherwise the account is scoped…, Shared by the single and bulk create endpoints. Raises HTTPException on any… (+3 more)
...
Cohesion: 0.18
Nodes (11): api.ts, Build and tooling, Components, Console health [verified], Data fetching pattern, Entry points, Frontend, Page inventory [verified — all 21 routes rendered and checked] (+3 more)

### Community 1302 - "Database"
Cohesion: 0.20
Nodes (10): Accuracy [verified 2026-08-06], Backup and restore, Database, Direct access, Key constraints, Live row counts [verified 2026-08-06], Migrations, ⚠️ One schema drift (+2 more)

### Community 1303 - "AeAssignment.tsx"
Cohesion: 0.29
Nodes (9): AeImportPreview, emptyRow(), Users(), AeAssignment(), fmtDateTime(), fmtNum(), ImportTab(), RosterTab() (+1 more)
...
### Community 1308 - "Customer Segmentation Rule"
Cohesion: 0.22
Nodes (9): Customer Segmentation Rule, Email digest (Gmail SMTP), No manual-override exemption — deliberately, The rule, The "Tier Shipping Gap" alert, Verification, What this replaces, Where it lives (+1 more)
...
### Community 1314 - "CustomerDirectory.tsx"
Cohesion: 0.43
...
### Community 1316 - "CustomerManagement.tsx"
Cohesion: 0.33
Nodes (4): CUSTOMER_TYPE_OPTIONS, EMPTY_FORM, FormState, STATUS_OPTIONS

### Community 1317 - "Customer 360 — Documentation"
Cohesion: 0.40
Nodes (5): Contents, Conventions used in these docs, Customer 360 — Documentation, Ground truth as of 2026-08-06 **[verified]**, The one-paragraph version
...
Cohesion: 0.83
Nodes (3): formatDate(), formatMoney(), Pipeline()

### Community 1323 - "padding-x"
Cohesion: 0.67
Nodes (4): padding-x, padding-x, $type, $value

### Community 1338 - "primary"
Cohesion: 0.67
Nodes (3): primary, $type, $value

## Knowledge Gaps
- **2694 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2689 more)
...
- **Why does `react` connect `react` to `time-series-chart-shell.tsx`, `area.tsx`, `y-domain-utils.ts`, `AnalyticsFilterBar.tsx`, `loading-sweep.tsx`, `Alerts.tsx`, `api`, `x-axis.tsx`, `AeAssignment.tsx`, `auth.tsx`, `Customer360.tsx`, `chart-defs.ts`, `leaderboard-rankings.tsx`, `api.ts`, `CustomerDirectory.tsx`, `AeTargets.tsx`, `CustomerManagement.tsx`, `Profitability.tsx`, `OperationalAnalytics.tsx`, `BusinessAnalytics.tsx`, `Pipeline.tsx`, `pie-context.tsx`, `chart-tooltip.tsx`, `App.tsx`, `plugins`, `DataQuality.tsx`, `projection-config.ts`, `use-animated-series-path.ts`, `chart-context.tsx`, `Rankings.tsx`, `sidebar-component.tsx`, `command.tsx`, `dropdown-menu.tsx`, `UniversalSearch.tsx`, `input-group.tsx`, `sheet.tsx`, `table.tsx`, `AEPerformance.tsx`, `navigation-menu.tsx`, `select.tsx`, `app-shell.tsx`, `card.tsx`, `MasterAirWaybills.tsx`, `series-markers.tsx`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `react-map-gl`, `@tanstack/react-query`, `@visx/curve`, `BusinessAnalytics.tsx`, `@visx/gradient`, `@base-ui/react`, `date-fns`, `cmdk`, `echarts-for-react`, `@carbon/icons-react`, `frontend/package.json`, `framer-motion`, `html2canvas`, `jspdf`, `lucide-react`, `maplibre-gl`, `motion`, `@number-flow/react`, `@radix-ui/react-avatar`, `@radix-ui/react-checkbox`, `@radix-ui/react-collapsible`, `@radix-ui/react-dialog`, `@radix-ui/react-dropdown-menu`, `@radix-ui/react-hover-card`, `@radix-ui/react-popover`, `@radix-ui/react-scroll-area`, `@radix-ui/react-select`, `@radix-ui/react-separator`, `@radix-ui/react-slot`, `@tanstack/react-table`, `react-is`, `@visx/event`, `tailwind-merge`, `@visx/group`, `@visx/responsive`, `@visx/scale`, `@visx/shape`, `class-variance-authority`, `Rankings.tsx`, `zod`, `d3-array`, `d3-shape`?**
