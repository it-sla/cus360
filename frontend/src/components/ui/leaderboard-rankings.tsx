...
// This project's theme (src/index.css) has no --color-rank-1/2/3 or success-600 tokens —
// mapped onto the existing amber/slate/orange (medal) and emerald (positive trend) palette
// already used elsewhere (e.g. pages/Rankings.tsx RANK_STYLE) rather than adding new global
// theme variables for a single component.
const crownColorMap = {
  1: "text-amber-500",
  2: "text-slate-400",
  3: "text-orange-500",
